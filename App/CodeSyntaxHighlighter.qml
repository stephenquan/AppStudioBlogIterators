...
SyntaxHighlighter {
    ...
    //property TextCharFormat stringFormat: TextCharFormat { foreground: "#a31515" }
    property TextCharFormat stringFormat: TextCharFormat { foreground: "#09885a" }
    //property TextCharFormat keywordFormat: TextCharFormat { foreground: "#0000ff" }
    property TextCharFormat keywordFormat: TextCharFormat { foreground: "#808000" }
    //property TextCharFormat propertyFormat: TextCharFormat { foreground: "#808000" }
